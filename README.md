...
## Places of Interest
The episodic memory logs generated by the BT executions are all contained in the [logs directory](logs/).

The results of the experiments are all contained in the [results directory](results/).

Examples of prompts provided to the LLMs are given in the [example prompts directory](btcm/experiment/example_prompts/).

Details on the behaviour trees used are given in the [cognitive sequence](btcm/examples/cognitive_sequence/) and [random BT](btcm/examples/random/) directories.
