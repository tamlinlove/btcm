...
from btcm.examples.cognitive_sequence.cognitive_sequence_environment import CognitiveSequenceEnvironment
...
def setup_board(vals):
    ...
    # Environment
    env = CognitiveSequenceEnvironment(state=board.state)
